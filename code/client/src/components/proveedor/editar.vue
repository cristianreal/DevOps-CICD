            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Ingrese el nombre" v-model="proveedor.nombre" id="namebuyer" name="namebuyer">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="lastnamebuyer">Apellido proveedor</label>
                        <input type="text" class="form-control" placeholder="Ingrese el apellido" v-model="proveedor.apellido" id="lastnamebuyer" name="lastnamebuyer">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="dirbuyer">Direccion domiciliar</label>
                        <input type="text" class="form-control" placeholder="Ingrese la direccion de su domicilio" v-model="proveedor.direccion" id="dirbuyer" name="dirbuyer">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="telbuyer">Telefono</label>
                        <input type="text" class="form-control" placeholder="Ingrese el numero de telefono" v-model="proveedor.telefono" id="telbuyer" name="telbuyer">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
						<label class="col-form-label" for="emailbuyer">Email</label>
						<input type="text" class="form-control" placeholder="Ingrese la direccion de correo electronico" v-model="proveedor.email" id="emailbuyer" name="emailbuyer">
					</div>
                    <div class="form-group">
                        <label class="col-form-label" for="webpage">Pagina web</label>
                        <input type="text" class="form-control" placeholder="Ingrese la direccion de correo electronico" v-model="proveedor.pagina_web" id="webpage" name="webpage">
                    </div>
                    <div class="form-group">
                        <label class="col-form-label" for="country">Pais</label>
                        <select class="custom-select" id="country" v-model="proveedor.pais" name="country" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Ingrese su ciudad"  v-model="proveedor.ciudad" id="city" name="city">
                    </div>
